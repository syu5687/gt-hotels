	...
	<div class="gtn-wrap">
	  ...
	  <div class="stay-spec">
		...
		<p class="spec-note">
		  ...
		  <a href="https://maps.app.goo.gl/Z3BnzJUyTiYCjye67" class="map" target="_blank" rel="noopener">(GoogleMap<img src="<?= asset('/_assets/images/window.svg') ?>" alt="別ウィンドウ" class="iconwindow">)</a>
